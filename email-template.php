<div>
    <p>Dear <?=htmlspecialchars($vars->fname, ENT_QUOTES);?>,<br>thank you for your enquiry. We will check our availability and contact you as soon as possible with booking details.</p>
    <p>Following are your transfer request details.</p>
    <div style="margin-top:30px">
        <table cellpadding="5" style="text-align:left;border-spacing:10px;border:1px #ccc solid">
            <tr>
                <td colspan="2" style="text-align:center;font-weight:bold;background-color:#edf8ff">One-way transfer</td>
            </tr>
            <tr>
            ...
            <?php endif; ?>
            <tr>
                <td colspan="2" style="text-align:center;font-weight:bold;background-color:#edf8ff">Your contact details</td>
            </tr>
            <tr>
                <th>Customer</th>
